...
gulp.task('index', function () {
    var target = gulp.src("src/main/resources/template/index.html");
    var sources = gulp.src(['src/main/resources/static/js/*.js', 'src/main/resources/static/css/*.css'], {read: false});
